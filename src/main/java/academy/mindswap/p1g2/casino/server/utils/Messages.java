...
public class Messages {
    ...
    /* CARDS */
    public static final String SUIT_HEART = "\033[1;31m♥\033[1m";

    public static final String SUIT_DIAMOND = "\033[1;31m♦\033[1m";

    public static final String SUIT_SPADE = "\033[1;31m♠\033[1m";

    public static final String SUIT_CLUB = "\033[1;31m♣\033[1m";

    //Votes ------------------------------------------------------------------------------------------------------------
    public static final String BLACKJACK_VOTE = "\n\nYou've voted on Blackjack. \nWaiting for everyone to vote.\n\n";
    public static final String POKER_VOTE = "\n\nYou've voted on Poker. \nWaiting for everyone to vote.\n\n";
    public static final String SLOTS_VOTE = "\n\nYou've voted on Slots. \nWaiting for everyone to vote.\n\n";
    ...
    public static final String VOTE_MESSAGE = "Vote for a game to play...";
